"""
Research Route Visualization App (with OSRM)

This Streamlit app provides a realistic visualization of predicted routes
using machine learning models and pathfinding algorithms, enhanced by
Open Source Routing Machine (OSRM) for accurate real-world road paths.

Intended for research and comparison with simple straight-line rendering.
"""
