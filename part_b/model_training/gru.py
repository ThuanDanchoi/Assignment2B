...
This script trains a GRU model to predict traffic volume based on past observations
using a sliding window technique. The trained model and test sets are saved to disk.
"""
...
np.save("../models/gru/X_test.npy", X_test)
np.save("../models/gru/y_test.npy", y_test)
