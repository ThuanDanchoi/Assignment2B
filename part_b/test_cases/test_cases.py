"""
Batch Test Runner for Route Prediction Pipeline

This script runs multiple test cases for different start/end locations,
pathfinding algorithms, and ML models. It logs the results including path
and predicted travel time into a timestamped .log file.
"""
